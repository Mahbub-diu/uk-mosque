...
(function ($) {
  ...
  const tabContents = document.querySelectorAll(
    '.mission-tabh4-outer .tab-content',
  );
  ...
  //Accordion Box
  if (
    $('.accordion-box, .accordion-box2, .accordion-box3, .accordion-box4')
      .length
  ) {
    $('.accordion-box, .accordion-box2, .accordion-box3, .accordion-box4').on(
      'click',
      '.acc-btn',
      function () {
